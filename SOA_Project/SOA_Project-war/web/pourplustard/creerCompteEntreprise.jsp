...
<head>
    ...
    <title>Créer Compte Entreprise</title>
					   ...
					   <div class="row">
                            ...
                            <fieldset>
								...
								<tr>
									...
									<td><input type="radio" name="typeentreprise" value="entreprise" checked/><label for="Entreprise">Entreprise</label>
										<input type="radio" name="typeentreprise" value="laboratoire"/><label for="Entreprise">Laboratoire</label></td>
								</tr>
								<div class="form-group">
									   <div><input name="nomEntreprise" placeholder="Nom Entreprise *" class="form-control" type="text" id="nomEntreprise"/></div>
								 </div> 
								<div class="form-group">
									   <div><input name="siret" placeholder="Numéro de Siret *" class="form-control" type="text" id="siret"/></div>
								 </div>
								 <div class="form-group">
								 ...
								 <div class="form-group">
									<div>
										<SELECT name="domaineAct" id="domaineAct"  class="btn btn-primary" >
												<OPTION >Choisir un domaine d'activité</OPTION>
								...
								<div class="form-group">
									<div>
										<SELECT name="tailleEtablissement" id="tailleEtablissement"  class="btn btn-primary" >
												<OPTION >Choisir Taille Etablissement</OPTION>
								...
								<div class="form-group">
								   <div><input name="adresseEtab" size="20" maxlength="20" placeholder="Adresse *" class="form-control" type="text" id="adresseEtab"/></div>
								</div>	
								<div class="form-group">
								   <div><input name="codePos" size="20" maxlength="20" placeholder="Code Postal *" class="form-control" type="text" id="codePos"/></div>
								</div>	
								<div class="form-group">
								   <div><input name="villeEtab" size="20" maxlength="20" placeholder="Ville *" class="form-control" type="text" id="villeEtab"/></div>
								</div>
								<div class="form-group">
									<div>
										<SELECT name="paysEtab" id="paysEtab"  class="btn btn-primary" >
								 ...
								 <div class="form-group">
								   <div><input name="telEtab" size="20" maxlength="20" placeholder="Telephone *" class="form-control" type="tel" id="telEtab"/></div>
								</div>
								 <div class="form-group">
									   <div><input name="emailEtab" placeholder="Email *" class="form-control" type="email" id="emailEtab"/></div>
								 </div>
								 <div class="form-group">
									   <div><input name="siteWebEtab" placeholder="Site Web *" class="form-control" type="text" id="siteWebEtab"/></div>
								 </div>							
							</fieldset><br>							
