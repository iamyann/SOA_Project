                            ...
                            <form method="post" action="ServletCreerCompteEtudiant" enctype="multipart/form-data">
                                ...
                                <legend>Enregistrement</legend>
                                    <label for="email">Email<red>*</red></label>
                                        <input type="email" name="email" id="email" class="form-control" size="20" maxlength="30" required><br> 
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="civilite">Sexe<red>*</red></label>
                                            <label class="radio-inline">
                                                <input type="radio" name="sexe" id="optionsRadiosInline1" value="M" checked/>Homme
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="sexe" id="optionsRadiosInline2" value="F"/>Femme<br>
                                            </label>
                                    </div>
                                    <label for="prenom">Prénom<red>*</red></label>
                                        <input type="text" id="prenom" name="prenom" class="form-control" size="20" maxlength="20" required/><br>
                                    ...
                                    <label for="ville">Ville<red>*</red></label>
                                        <input type="text" id="ville" name="ville" class="form-control" size="20" maxlength="20" required/><br>
                                    ...
                                    <label for="telephone">Téléphone<red>*</red></label>
                                        <input type="tel" id="telephone" name="telephone" class="form-control" size="10" maxlength="10" required/><br>
                                    <label for="etablissement_scolaire">Etablissement scolaire<red>*</red></label>
                                        ...
                                        <select id="etablissement_scolaire" name="etablissement_scolaire" class="form-control" required>
                                            <option value="INSA" id="INSA">INSA</option>
                                        </select><br>
                                    <label for="specialite">Spécialité<red>*</red></label>
                                            <select id="spe" name="spe" class="form-control" required>
