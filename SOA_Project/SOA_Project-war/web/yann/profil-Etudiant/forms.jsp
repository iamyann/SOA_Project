                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <label class="checkbox-inline">
                                    <input type="checkbox">Aucune Preference
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Intitule Stage</label>
                                <select multiple class="form-control">
                                    <option>Ingenieur Securite</option>
                                    <option>Ingenieur Cloud</option>
                                    <option>Developpeur Web</option>
                                    <option>Developpeur Java</option>
                                    <option>Architecte Reseau</option>
                                </select>
                            </div>
