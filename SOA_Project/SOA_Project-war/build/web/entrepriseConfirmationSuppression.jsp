...
<head>
    ...
    <title>Suppression Offre de Stage</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h2>Voulez-vous vraiment supprimer l'offre "Référence de l'offre" ?</h2>
                        ...
                        <div class="table-responsive">
                            <form role="form" method="post" action="/SOA_Project-war/SupprimerOffreServlet" >
                                <button type="submit" name="buttonD" value="oui" class="btn btn-default">Oui</button>
                                <button type="submit" name="buttonD" value="non" class="btn btn-default">Non</button>
                            </form>
                        </div>
                    </div>              
