                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <form role="form" method="get" action="EntrepriseModifierProfil">
                                ...
                                <div class="form-group">
                                    <label>Siret : </label> ${siretEnt}                                  
                                </div>
                                <div class="form-group">
                                    <label>Domaine d'activités : </label> ${domaineEnt}
                                </div> 

                                <div class="form-group">
                                   <label>Taille : </label> ${tailleEnt}
                                </div>

                                <div class="form-group">
                                    <label>Adresse : </label> ${adresseEnt}, ${codepostalEnt}, ${villeEnt}, ${paysEnt} 
                                </div>

                                <div class="form-group">
                                    <label>Téléphone : </label> ${telephoneEnt}
                                </div>
                                <div class="form-group">
                                    <label>Site web : </label> ${sitewebEnt}
                                </div>
