...
public abstract class AbstractFacade<T> {
    ...
    public List<T> findByCand(Object nometudiant) {
    ...
    public List<T> findBySiret(Object siret) {
     ...
     */
    public List<T> getSpontForName(Object nometudiant){
